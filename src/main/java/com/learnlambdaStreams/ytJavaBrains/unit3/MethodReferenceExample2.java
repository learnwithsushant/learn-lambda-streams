...
public class MethodReferenceExample2 {
    ...
    public static void main(String[] args) {
        ...
        performContitionally(people, p-> true,System.out::println);
        ...
        performContitionally(people, p -> p.getLastName().startsWith("D"),System.out::println );
        System.out.println("============================================");
        System.out.println("===================Create a method that prints all the firstname starting with B using lambda=========================");
        performContitionally(people, p -> p.getFirstName().startsWith("B"),System.out::println);
        System.out.println("============================================");
    }
